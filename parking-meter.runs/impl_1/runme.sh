...
HD_PWD=C:/Users/BURAKPC/Vivado/parking-meter/parking-meter.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log display_controller.vdi -applog -m64 -messageDb vivado.pb -mode batch -source display_controller.tcl -notrace
